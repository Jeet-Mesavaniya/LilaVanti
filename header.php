      ...
      <div class="contact_nav custom-contact-nav">
          <div class="contact_row custom-contact-row">
              ...
              <a href="tel:8866320893">
                <img id = "twitter-img" src = "images/whatsapp.svg" alt="My Happy SVG" style="width : 20px; height : 24px" aria-hidden="true"/>
                ...
                <ul class="navbar-nav  ">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLinkAbout">
                      ...
                      <a class="dropdown-item" href="index.php#aboutTrustee">Trustee Details</a>
