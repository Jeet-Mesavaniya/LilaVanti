...
<br>
  ...
  <!-- team section -->
  <div class="trustee-back-change m-lg-5 mr-5">
    <section class="team_section layout_padding">
      <div class="container">
        ...
        <!-- trustee 1 end -->
         ...
         <!-- trustee 2 -->
         <div class="trustee-box  mt-5" id="trusteeALKA">
          <div class="img-box-trustee">
            <img src="images/Alkaben-Photo.jpg" alt="ALKA K VORA" />
          </div>
          <div class="name-info">
            <h5>ALKA K VORA</h5>
            <h6>SECRETARY</h6>
        ...
        <!-- trustee 3 -->
        <div class="trustee-box  mt-5" id="trusteeAmiben">
          <div class="img-box-trustee">
            <img src="images/AmiBhatt-Photo.jpg" alt="SHRI AMIBEN BHATT" />
          </div>
          <div class="name-info">
        ...
        <!-- trustee 4 -->
        <div class="trustee-box  mt-5" id="trusteeDENISHBHAI">
          <div class="img-box-trustee">
        ...
        <!-- trustee 5 -->
        <div class="trustee-box  mt-5" id="trusteeSAVALIYA">
          <div class="img-box-trustee">
            <img src="images/Dhanjibhai-Photo.jpg" alt="SHRI DR. D P SAVALIYA" />
          </div>
          <div class="name-info">
            <h5>SHRI DR. D P SAVALIYA </h5>
            <h6>TRUSTEE</h6>
            <p>
              What does it truly mean to achieve 'holistic health'? At its core, the term 'holistic' embodies the interconnectedness of all aspects within a system, understood comprehensively only when viewed as a unified whole. When applied to our well-being, holistic health extends far beyond mere physicality, encompassing mental, emotional, social, and even spiritual dimensions.
              <br><br>
              In today's fast-paced world, our systems often compartmentalize health—nutritionists focus on dietary advice, therapists offer strategies for stress management, yet these facets often exist in isolation, lacking a unified approach.
              <br><br>
              Enter Shri Dr. D P Savaliya, whose holistic approach to health embodies this interconnected perspective. As a leading figure in the field of holistic medicine, Dr. Savaliya emphasizes the integration of physical, mental, and emotional well-being in his practice. His guidance reminds us that true health involves nurturing positive thoughts, developing effective coping mechanisms, and fostering harmonious relationships with both our surroundings and others.
              <br><br>
        ...
        <!-- trustee 6 -->
        <div class="trustee-box  mt-5" id="trusteeSEJALBEN">
          <div class="img-box-trustee">
        ...
        <!-- trustee 6 end -->
        <!-- trustee 7 -->
        <div class="trustee-box  mt-5" id="trusteeSUNILBHAI">
          <div class="img-box-trustee">
            <img src="images/SunilBhatt-Photo.jpg" alt="SHRI KISHANBHAI VORA" />
          </div>
          <div class="name-info">
            ...
            <p>
              The true essence of education lies not in dictating what to think, but in fostering the capacity to think critically and independently. It's about cultivating minds that are adept at reasoning and discerning, rather than merely memorizing the ideas of others.
              <br><br>
              The human body is a marvel of resilience, equipped to withstand countless challenges and adaptations imposed by its surroundings. Yet, the key to maintaining optimal health lies in our ability to effectively adapt to the ever-changing stresses we encounter.
              <br><br>
              Enter Shri Sunilbhai Bhatt, whose profound understanding of health and wellness illuminates this principle. With a keen focus on holistic well-being, Sunilbhai Bhatt emphasizes the importance of adaptability in maintaining vitality and resilience. Under his guidance, individuals are empowered to embrace change, cultivate resilience, and thrive amidst life's myriad challenges.
              <br><br>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="info_links">
              ...
              <div class="info_links_menu">
                ...
                <a href="Trustee.php" class="active">Trustee Details</a>
